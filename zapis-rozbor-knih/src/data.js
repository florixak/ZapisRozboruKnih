...
export const authors = [
  ...
  },
  {
    ...
    interest: [
      ...
      "Otevřeně krizoval politické dění =>",
      "Kvůli své kritice raukouské absolutistické vlády byl pronásledován policií a také následně převezen do tyrolského města Brixen pod pocilejní dohled",
...
export const ikt_questions = [
  ...
  },
  {
    ...
    answer: [
      ...
      "- zahrnuje fakta (můžeme je průměrovat, počítat, sumovat) a dimenze (kategorie, podle kterých data analyzujeme).",
      "Klasifikace dat:",
