...
export const vap_questions = [
  ...
  },
  {
    ...
    answer: [
      ...
      "- Je multiplatfomní - běží na všech operačních systémech",
      "- OOP = je objektově orientovaná",
      "- JVM = je virtuální stroj ",
      "- Čtyři základní platformy = SE (Standard Edition), EE (Enterprice Edition), ME (Mobile), FX",
      "- JRE = knihovny pro běh Java aplikací",
      "- JDK = knihovny pro vývoj Java aplikací",
      "- Deklarace proměnných, konstant",
      "- Datové typy, operátory, identifikátory = int, double, char, boolean, String",
      "- Vstup/výstup z terminálu",
      "- Komentáře, dokumentace = jednořádkové //, víceřádkové /**/, dokumentační /** */",
      "- silné a slabé typování = uvádění datového typu (Java má striktní datové typy)",
    ],
  },
  {
    id: 3,
    ...
    answer: [
      "- Větvení programu, logické spojky a operátory",
      "- dělí se na větvení a cykly",
      " ",
      "- Větvení programu:",
      "  - if - podmínka, provede se pokud platí podmínka",
      "  - if-else - podmínka s větví else, provede se if nebo else (pokud platí první podmínka, tak se pod ní už nevykonají)",
      "  - else-if - vnořené podmínky",
      "  - switch - větvení podle hodnoty proměnné",
      " ",
      "- Cykly:",
      "  - while - cyklus s podmínkou, neskončí dokud platí podmínka",
      "  - do-while - cyklus s podmínkou na konci, proběhne alespoň jednou a dále jako normální while",
      "  - for - cyklus s pevným počtem opakování",
      "  - foreach - cyklus pro procházení kolekcí",
      " ",
      "- Logické operátory: ==, !=, >, <, >=, <=",
      " ",
      "- Logické spojky: && (zároveň), || (nego), ! (negace)",
    ],
  },
  {
    id: 4,
    ...
    answer: [
      "- Třída:",
      "   - šablona pro tvorbu objektu",
      "   - obsahuje atributy a metody",
      "   - Sama o sobě nazabírá žádnou paměť",
      "   - Název se píše s velkým písmenem, PascalCase",
      " ",
      "- Atributy:",
      "   - proměnné uvnitř třídy",
      "   - reprezentují vlastnosti objektu",
      "   - mohou být různých datových typů",
      "   - názvy začínají malými písmeny, camelCase (např. int pocetZivotu), nebo podržítkem _ mezi slovy (např. int pocet_zivotu)",
      " ",
      "- Metody:",
      "   - funkce uvnitř třídy",
      "   - Přetěžování metod: metody mají stejný název, jiné parametry",
      "   - Návratový typ, název, parametry",
      "   - Název začíná malým písmenem, camelCase",
      " ",
      "- Přistupové modifikátory:",
      "   - public - přístupné zvenku",
      "   - private - přístupné pouze uvnitř třídy",
      "   - protected - přístupné v rámci balíčku a potomků",
      "   - default - přístupné v rámci balíčku",
      " ",
      "- Kvalifikátory:",
      "   - static - přístupné bez vytvoření instance třídy",
      "   - final - konstanta, nelze měnit",
      "   - abstract - nemá tělo, musí být přepsáno v potomkovi",
      "   - synchronized, volatile, transient, native",
      " ",
      "- Konstruktor:",
      "   - metoda, která se volá při vytvoření instance třídy, speciální metoda, která nic nevrací",
      "   - slouží k inicializaci objektu, nastavuje vlastnosti objektu a vytváří ho",
      "   - může mít parametry",
      "   - pokud není definován, vytvoří se defaultní konstruktor",
      " ",
      "- Instance (objekty):",
      "   - konkrétní vytvořený objekt třídy",
      "   - vytvoření pomocí klíčového slova new",
      "   - přístup k atributům a metodám pomocí tečkové notace",
      " ",
      "- Třída Object:",
      "   - všechny třídy v Javě jsou potomky třídy Object",
      "   - obsahuje metody: toString(), equals(), hashCode(), clone()",
      "   - v Javě je skoro všechno objekt, až na primitivní datové typy",
    ],
  },
  {
    id: 5,
    ...
    answer: [
      ...
      " ",
      "&lJednorozměrné pole:",
      "- jednorozměrné pole je kolekce prvků stejného datového typu",
      "- Deklarace pole:",
      "   - int[] pole = new int[5];",
      "   - int[] pole = new int[]{1, 2, 3, 4, 5};",
      "- Přístup k prvkům pole:",
      "   - přístup k poli je od indexu 0",
      "   - int i = pole[0]; -> 1",
      "- Cyklus pro procházení pole:",
      "   for (int i = 0; i < pole.length; i++) {",
      "      System.out.println(pole[i]);",
      "   }",
      " ",
      "&lKolekce:",
      "- ArrayList - dynamické pole, které se může měnit, dobře se vyhledává, špatně se přidává",
      "- HashSet - kolekce unikátních prvků, Set narozdíl od listů nezachovává pořadí",
      "- LinkedList - kolekce, která uchovává prvky ve spojovém seznamu, každý prvek ví o tom co je za ním, lehce se do něj přidává",
      "- Queue - kolekce, která uchovává prvky ve frontě, fronta, FIFO, metody: add(), remove(), pop(),",
      "- Map - kolekce, která uchovává klíče a hodnoty",
      "- HashMap - kolekce, která uchovává klíče a hodnoty, klíče jsou unikátní",
      " ",
      "- Rozdíl mezi polem a kolekcí:",
      "   - pole má pevnou velikost, kolekce se může měnit",
      "- Metody:",
      " - compareTo(Object o) - vrací hodnotu 1 nebo -1, porovnává obsah",
      " - equals(Object o) - porovnává dva objekty, porovnává objekty",
      " ",
      "- Třída Collections je třída obsahující statické metody pro práci s kolekcemi",
      "- Metody třídy Collections:",
      "   - sort(List<T> list) - seřadí prvky v kolekci",
      "   - shuffle(List<?> list) - zamíchá prvky v kolekci",
      "   - reverse(List<?> list) - obrátí pořadí prvků v kolekci",
      "   - min(Collection<? extends T> coll) - vrátí nejmenší prvek v kolekci",
      "   - max(Collection<? extends T> coll) - vrátí největší prvek v kolekci",
    ],
  },
  {
    id: 6,
    ...
    answer: [
      ...
      "- Třída Scanner",
      " ",
      "  - Soubor je množina údajů uložena na vnější paměti počítače",
      "  - Typické operace: čtení dat, zápis dat",
      " ",
      "&lTřída File:",
      "  - reprezentuje soubor nebo adresář",
      "  - metody: exists(), createNewFile(), mkdir(), delete()",
      " ",
      "&lProudy (Streams) znaků/bajtů:",
      "  - Proud (Streams) jsou nástroje pro přenos informací",
      "  - Bajtové proudy jsou proudy s binárními daty (obrázky, audio)",
      "  - FileInputStream, FileOutputStream",
      "  - Znakové proudy jsou proudy s textovými daty (text)",
      "  - FileReader, FileWriter, BufferedReader, BufferedWriter",
      " ",
      "&lTřídy vlastností:",
      "  - BufferedWriter - zapisuje text do souboru",
      "  - BufferedReader - čte text ze souboru",
      "  - PrintWriter - zapisuje text do souboru",
      "  - FileReader - čte data ze souboru",
      "  - FileWriter - zapisuje data do souboru",
      " ",
      "&lTřída Scanner:",
      "  - umožňuje číst vstup od uživatele",
      "  - metody: nextInt(), nextDouble(), nextLine()",
      "  - vytvoříme instanci, předáme ji jako parametr System.in",
      " ",
    ],
  },
  {
    ...
    answer: [
      ...
      " ",
      "&lDědičnost:",
      "- způsob, kterým může třídat získat atributy a metody (všechno) jiné třídy",
      "- Rodič = třída, která je předává",
      "- Potomek = třída, která dědí",
      "- Dědění pomocí klíčového slova extends",
      "- Možnost odkazování na rodičovskou třídu pomocí klíčového slova super",
      "- Překrývání metod:",
      "  - Metoda potomka má stejný název a parametry jako metoda rodiče, vytvoří vlastní metodu",
      "  - Modifikátor protected umožňuje přístup k metodě potomkovi",
      "- Přetěžování metod:",
      "  - Metody mají stejný název, ale jiné parametry",
      "  - Volání metody podle počtu a typu parametrů",
      " ",
      "&lZapouzdření:",
      "- skrytí dat a metod objektu",
      "- přístup k datům objektu pouze na základě jeho metod (getter a setter)",
      "- Klíčové slovo pro zapouzdření je private",
      "- Zabezpečení",
      " ",
      "&lPolymorfismus:",
      "- Možnost přepsat metodu v potomkovi",
      "- Abstraktní třída (abstract class) - třída, která obsahuje alespoň jednu abstraktní metodu, ta je bez těla",
      "- Rozhraní (interface) - soubor metod bez těla, potomci můžou mít více rozhraní, klíčové slovo implements",
      "- Rozdíl mezi abstraktní třídou a rozhraním:",
      "  - Abstraktní třída může mít metody s tělem, rozhraní nemá",
    ],
  },
  {
    id: 8,
  ...
  {
    id: 9,
    question: "Java grafika, práce s databází (VAP moje otázka)",
    answer: [
